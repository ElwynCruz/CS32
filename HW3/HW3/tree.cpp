...
int countIncludes(const double a1[], int n1, const double a2[], int n2)
{
	...
	int numIncludes = 0;
	if (a1[0] == a2[0])
		numIncludes += countIncludes(a1 + 1, n1 - 1, a2 + 1, n2 - 1);
	numIncludes += countIncludes(a1+1, n1-1, a2, n2);
...
void order(double a[], int n)
{
	...
	divide(a, n, a[0], firstNotGreater, firstLess);						// for i such that firstNotGreater < i < firstLess, already in ordered spot
